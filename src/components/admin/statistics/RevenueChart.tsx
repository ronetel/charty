      ...
      <div style={{ width: "100%", height: 300 }}>
        <ResponsiveContainer>
          <LineChart data={data as any}>
            ...
            <YAxis stroke="#A1A1A1" />
            <Tooltip />
            <Line type="monotone" dataKey="revenue" stroke="#83B4FF" dot={false} />
          </LineChart>
        </ResponsiveContainer>
      </div>
    </div>
