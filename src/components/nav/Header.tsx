        ...
        <div className={styles.header__wrapper}>
          ...
          {isLoggedIn ? (
            <div className={styles.header__cart}>
              ...
              <div className={styles.header__cart_line}></div>
              <ProfileButton onClickSignIn={onRegisterModalOpen} />
            </div>
          ) : (
            <ProfileButton onClickSignIn={onRegisterModalOpen} />
          )}
          ...
          {isLoginModalOpen && (
            <LoginForm isOpen={isLoginModalOpen} onClose={onLoginModalClose} onSwitchToRegister={() => { onLoginModalClose(); onRegisterModalOpen(); }} />
          )}

          {isRegisterModalOpen && (
            <RegisterForm onClose={onRegisterModalClose} isOpen={isRegisterModalOpen} onSwitchToLogin={() => { onRegisterModalClose(); onLoginModalOpen(); }} />
          )}
          {isCartMenuOpen && (
            <CartMenu
              onClose={onCartMenuClose}
